...
export default function PdfDocument({ pattern, title = 'My Crochet Pattern' }: PdfDocumentProps) {
      ...
      {bands.map((band, pageIdx) => {
        ...
        return (
          <Page key={pageIdx} size="A4" style={styles.page}>
            ...
            {/* Instructions — last page only */}
            {isLast && <PdfInstructions stitchStyle={meta.stitchStyle} />}
