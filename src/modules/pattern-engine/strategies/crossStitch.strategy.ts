 ...
 *
 * Functionally identical to singleCrochet grid generation.
 * The key rendering difference is showSymbols: true — cross stitch charts
 * are traditionally used in B&W, so symbols are essential to tell colours apart.
 */
