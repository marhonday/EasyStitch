  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#FAF6EF' }}>
      ...
      <div style={{ flex: 1, padding: '8px 24px 60px', maxWidth: 480, margin: '0 auto', width: '100%' }}>
        ...
        {/* What CraftWabi is — brand identity */}
        <div style={{ background: 'rgba(196,97,74,0.06)', borderRadius: 16, padding: '14px 18px', marginBottom: 14, border: '1px solid rgba(196,97,74,0.15)' }}>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 13, color: '#C4614A', marginBottom: 6 }}>What CraftWabi is</p>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: '#6B5744', lineHeight: 1.75 }}>
            CraftWabi is a <strong style={{ color: '#2C2218' }}>digital pattern generation and project tracking tool</strong> for fibre arts — crochet, knitting, cross-stitch, diamond painting, and paint by number. It is not a sewing tool, not a physical kit, and not a sewing pattern service. It helps crafters convert photos into stitch graphs and follow their project step by step.
          </p>
        </div>
